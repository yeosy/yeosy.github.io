...
/******/ 			var chunk = require("./" + ({"1":"components/main","2":"components/nuxt-logo","3":"components/project-list","4":"components/tutorial","5":"pages/index"}[chunkId]||chunkId) + ".js");
...
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
__webpack_require__(5).default("41f7b0c1", content, true)
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, "html{line-height:1.15;-webkit-text-size-adjust:100%}body{margin:0}main{display:block}h1{font-size:2em;margin:.67em 0}hr{box-sizing:content-box;height:0;overflow:visible}pre{font-family:monospace,monospace;font-size:1em}abbr[title]{border-bottom:none;text-decoration:underline;-webkit-text-decoration:underline dotted;text-decoration:underline dotted}b,strong{font-weight:bolder}code,kbd,samp{font-family:monospace,monospace;font-size:1em}small{font-size:80%}sub,sup{font-size:75%;line-height:0;position:relative;vertical-align:baseline}sub{bottom:-.25em}sup{top:-.5em}img{border-style:none}button,input,optgroup,select,textarea{font-family:inherit;font-size:100%;line-height:1.15;margin:0}button,input{overflow:visible}button,select{text-transform:none}[type=button],[type=reset],[type=submit],button{-webkit-appearance:button}[type=button]::-moz-focus-inner,[type=reset]::-moz-focus-inner,[type=submit]::-moz-focus-inner,button::-moz-focus-inner{border-style:none;padding:0}[type=button]:-moz-focusring,[type=reset]:-moz-focusring,[type=submit]:-moz-focusring,button:-moz-focusring{outline:1px dotted ButtonText}fieldset{padding:.35em .75em .625em}legend{box-sizing:border-box;color:inherit;display:table;max-width:100%;padding:0;white-space:normal}progress{vertical-align:baseline}textarea{overflow:auto}[type=checkbox],[type=radio]{box-sizing:border-box;padding:0}[type=number]::-webkit-inner-spin-button,[type=number]::-webkit-outer-spin-button{height:auto}[type=search]{-webkit-appearance:textfield;outline-offset:-2px}[type=search]::-webkit-search-decoration{-webkit-appearance:none}::-webkit-file-upload-button{-webkit-appearance:button;font:inherit}details{display:block}summary{display:list-item}[hidden],template{display:none}blockquote,dd,dl,dt,fieldset,form,h1,h2,h3,h4,h5,h6,legend,li,ol,p,pre,td,th,ul{margin:0;padding:0;font-size:100%}fieldset{border:0}input{margin:0;padding:0}button,input,select{-webkit-appearance:none;-webkit-border-radius:0}select{-webkit-appearance:menulist}input[type=checkbox]{-webkit-appearance:checkbox}input[type=radio]{-webkit-appearance:radio}h1,h2,h3,h4,h5,h6{font-weight:400}ol,ul{list-style:none}table{border-collapse:collapse;border-spacing:0}strong{font-weight:400}em{font-style:normal}html{font-size:62.5%}body{-webkit-font-smoothing:antialiased;word-break:keep-all;word-break:break-word;word-wrap:break-word;line-height:1.35;font-family:\"Roboto\",\"Noto sans KR\",\"Apple SD Gothic Neo\",sans-serif}img{border:0;vertical-align:top}a[disabled],button[disabled]{cursor:default}a{color:inherit;background-color:transparent;text-decoration:none}button{margin:0;padding:0;color:inherit;background-color:transparent;cursor:pointer;border:0}button,input,select,textarea{outline:none;line-height:inherit;vertical-align:top;letter-spacing:inherit;font:inherit;font-size:100%}input,select,textarea{resize:none}input::-ms-clear,select::-ms-clear,textarea::-ms-clear{display:none}input::-webkit-inner-spin-button,select::-webkit-inner-spin-button,textarea::-webkit-inner-spin-button{display:none}input::-moz-placeholder,select::-moz-placeholder,textarea::-moz-placeholder{color:inherit}input::placeholder,select::placeholder,textarea::placeholder{color:inherit}input:-ms-input-placeholder,select:-ms-input-placeholder,textarea:-ms-input-placeholder{color:inherit}input::-ms-input-placeholder,select::-ms-input-placeholder,textarea::-ms-input-placeholder{color:inherit}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
__webpack_require__(5).default("768564e1", content, true)
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, "body{width:100%;background-color:#090c0b;color:#fff;-webkit-tap-highlight-color:rgba(0,0,0,0)}body,body #wrapper{position:relative}body #container .page{position:relative;left:0;top:0}body #container .page.page-enter-active{transition:.5s;z-index:2}body #container .page.page-leave-active{z-index:-1;transition:0s}body #container .page.page-enter{transform:translateZ(0);opacity:0}body #container .page.page-enter-to{transform:translateZ(0);opacity:1}body #container .page.page-leave{opacity:1}body #container .page.page-leave-to{opacity:0}body #container .page .page-enter-active,body #container .page .page-leave-active{transition:opacity .5s}body #container .page .page-enter,body #container .page .page-leave-to{opacity:0}body #container .page .page-enter-to,body #container .page .page-leave{opacity:1}body .fade-enter-active,body .fade-leave-active{transition:opacity .5s}body .fade-enter,body .fade-leave-to{opacity:0}body .fade-enter-to,body .fade-leave{opacity:1}#app.pc{min-width:1200px}#app.pc #container{max-width:2560px;margin:0 auto}#app.pc #container,#app.pc .page{min-height:600px}#app.mobile{width:800px;overflow:hidden}#app.mobile #container,#app.mobile .page{min-height:calc(100vh - 80px)}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
const state = () => ({
  visibleSecList: [] // 인터센션 visible 영역
});

const getters = {
  getVisibleSecList(state) {
    return state.visibleSecList;
  }
};
const mutations = {
  setVisibleSecList(state, list) {
    state.visibleSecList = list;
  }
};
...
const _7b020f52 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 5).then(__webpack_require__.bind(null, 41)));
...
// EXTERNAL MODULE: ./assets/scss/_document.scss
var _document = __webpack_require__(20);

// EXTERNAL MODULE: ./assets/scss/_layout.scss
...
(function updateModules() {
  ...
  resolveStoreModules(__webpack_require__(24), 'ui.js');
...
const Main = () => __webpack_require__.e(/* import() | components/main */ 1).then(__webpack_require__.bind(null, 33)).then(c => wrapFunctional(c.default || c));
const NuxtLogo = () => __webpack_require__.e(/* import() | components/nuxt-logo */ 2).then(__webpack_require__.bind(null, 43)).then(c => wrapFunctional(c.default || c));
const ProjectList = () => __webpack_require__.e(/* import() | components/project-list */ 3).then(__webpack_require__.bind(null, 34)).then(c => wrapFunctional(c.default || c));
const Tutorial = () => __webpack_require__.e(/* import() | components/tutorial */ 4).then(__webpack_require__.bind(null, 42)).then(c => wrapFunctional(c.default || c));
...
/* Plugins */
 ...
 // Source: ..\\plugins\\site.client.js (mode: 'client')
  ...
  const app = {
    head: {
      ...
      "link": [{
        ...
        "rel": "stylesheet",
        "href": "https:\u002F\u002Ffonts.googleapis.com\u002Fcss2?family=Noto+Sans+KR:wght@100;300;400;500;700;900&display=auto"
      }, {
        "rel": "stylesheet",
        "href": "https:\u002F\u002Ffonts.googleapis.com\u002Fcss2?family=Roboto:wght@300;400;700;900&display=auto"
      }],
      "style": [],
      "script": []
    },
...
module.exports = require("v-intersect");
